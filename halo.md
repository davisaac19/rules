...
* **Sesiones de Juego:** Se requiere una conexión mínima de **1 hora continua**.
...
* **Quórum de 3:** Las reglas de este reglamento (disciplina, conducta, desempeño y campaña) solo son válidas y aplicables en partidas donde estén presentes **los 3 miembros** (4 en el caso de la campaña). Si solo se conectan 2 (o 3 en la campaña) jugadores **desde el inicio**, ninguna sanción de este reglamento aplica para esa sesión.
